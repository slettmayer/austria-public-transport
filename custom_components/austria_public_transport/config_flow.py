"""Config flow for the Austria Public Transport integration."""
...
class WienerLinienMonitorConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Austria Public Transport."""
...
class WienerLinienMonitorOptionsFlow(OptionsFlow):
    """Handle options flow for Austria Public Transport."""
